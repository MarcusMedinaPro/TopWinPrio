...
internal sealed class Program
{
    ...
    [SuppressMessage("CodeQL", "cs/useless-assignment-to-local", Justification = "Mutex variable must be held for application lifetime to prevent multiple instances. Discard pattern (_) also used for MessageBox.Show() DialogResult.")]
